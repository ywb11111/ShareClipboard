...
class ManualConnectionTest {
    ...
    private fun listener(latch: CountDownLatch) = object : LanSyncService.Listener {
        override fun onPeersChanged(peers: List<PeerDevice>) { if (peers.isNotEmpty()) latch.countDown() }
